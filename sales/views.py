...
def fully(request):
    ...
    return render(request, 'fully.html', context=context)
...
def partially(request):
    ...
    context = {"categories": categories, 'values': values, 'data': data, 'table_data':table_content}
    return render(request, 'partially.html', context=context)

def cannotbe(request):
    ...
    context = {"categories": categories, 'values': values, 'data': data, 'table_data':table_content}
    return render(request, 'cannotbe.html', context=context)